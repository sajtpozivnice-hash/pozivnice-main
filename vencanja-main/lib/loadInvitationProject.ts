...
/**
 * Load a published invitation by slug.
 * - Subdomain tenants: require x-invitation-site header (set by middleware rewrite).
 * - Apex path `/i/[site]`: public by slug (works with www → apex redirect).
 */
