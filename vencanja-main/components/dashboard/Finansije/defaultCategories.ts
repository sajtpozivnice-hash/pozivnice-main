...
const COMING_OF_AGE_BUDGET_CATEGORIES: DefaultBudgetCategorySeed[] = [
  ...
  { name: "Odeća", icon: "Shirt", color: "#1d4ed8", sort_order: 8 },
  { name: "Zabava", icon: "PartyPopper", color: "#ea580c", sort_order: 9 },
  { name: "Pokloni", icon: "Gift", color: "#e11d48", sort_order: 10 },
  { name: "Ostalo", icon: "Wallet", color: "#64748b", sort_order: 11 },
];

const KIDS_BIRTHDAY_BUDGET_CATEGORIES: DefaultBudgetCategorySeed[] = [
  { name: "Lokacija", icon: "Hotel", color: "#4f46e5", sort_order: 1 },
  { name: "Torta", icon: "Cake", color: "#c2410c", sort_order: 2 },
  { name: "Hrana", icon: "UtensilsCrossed", color: "#b45309", sort_order: 3 },
  { name: "Piće", icon: "Wine", color: "#9333ea", sort_order: 4 },
...
> = {
  ...
  comingOfAge: COMING_OF_AGE_BUDGET_CATEGORIES,
  kidsBirthday: KIDS_BIRTHDAY_BUDGET_CATEGORIES,
