...
const FormConfirmMessage: FC<Props> = ({ attendance, onClick }) => {
  ...
  return (
    <div className="rounded-2xl border border-white/15 bg-white px-6 py-12 text-center text-v3-ink shadow-xl sm:px-10">
      <p className="v3-eyebrow mb-4">{isYes ? "Hvala Vam" : "Žao nam je"}</p>
      <h3
      ...
      <p className="mt-4 text-sm text-v3-muted">
        {isYes
