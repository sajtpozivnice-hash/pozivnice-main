    ...
    <section id={id} className="v3-section bg-v3-ivory">
      <div className="v3-container">
        <div className="mb-14 text-center">
          ...
          {data.description ? (
            <p className="v3-subheading">{data.description}</p>
          ) : null}
        </div>

        {images.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-black/10 bg-white/50 px-6 py-16 text-center text-sm text-v3-muted">
