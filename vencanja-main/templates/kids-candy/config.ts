...
const IMG = {
  ...
  portrait:
    "https://res.cloudinary.com/dqqnpfbyf/image/upload/v1787327398/katie-rainbow-U21WOE0jB0E-unsplash_n9pimf.jpg",
  balloons:
    "https://res.cloudinary.com/dqqnpfbyf/image/upload/v1787327481/jonathan-borba-37HRziPIeAw-unsplash_aq0u5k.jpg",
  cake:
...
export const kidsCandyDefaultConfig: UniversalProjectConfig = {
  template: "kids-candy",
  eventType: "kidsBirthday",
  meta: {
    title: "Mila — candy magazin rođendan",
    description: "Šarena candy pozivnica za prvi dečiji rođendan"
  },
  event: {
    date: "2026-09-20",
    rsvpDate: "2026-09-10",
  ...
  sections: [
    {
      ...
      order: 1,
      data: {
        title: "Prvi candy cover!",
        subtitle: "Candy magazine party",
        description:
        ...
        items: [
          {
            id: "1",
            time: "17:00",
            title: "Red carpet ulaz",
            description: "Photo corner i nalepnice.",
          },
          {
            id: "2",
            time: "17:30",
            title: "Igre i playlist",
            description: "Timski izazovi i karaoke.",
          },
          {
            id: "3",
            time: "18:15",
            title: "Naslovna torta",
