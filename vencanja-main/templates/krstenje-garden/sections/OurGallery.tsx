    ...
    <section id={id} className="kg-section bg-kg-ivory">
      <div className="kg-container">
        <div className="mb-14 text-center">
          ...
          {data.description ? (
            <p className="kg-subheading">{data.description}</p>
          ) : null}
        </div>

        {images.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-black/10 bg-white/50 px-6 py-16 text-center text-sm text-kg-muted">
