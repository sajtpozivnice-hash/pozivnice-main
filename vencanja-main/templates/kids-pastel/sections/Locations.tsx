    ...
    <section id={id} className="kpas-section">
      <div className="kpas-shell">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="kpas-plate"
        >
          <div
            className={`kpas-plate-media ${image ? "" : "kpas-plate-media--empty"}`}
          >
            {image ? (
          ...
          <div className="kpas-plate-body">
            <span className="kpas-plate-seal kpas-seal">
            ...
            {card?.location ? (
              <p className="mt-5 flex items-start justify-center gap-2 text-base text-black/70">
