...
export const kidsPastelDefaultConfig: UniversalProjectConfig = {
  template: "kids-pastel",
  eventType: "kidsBirthday",
  meta: {
    title: "Lena — pozivnica kao naslovna strana knjige",
    description: "Nežna storybook pozivnica za prvi dečiji rođendan"
  },
  event: {
    date: "2026-09-20",
    rsvpDate: "2026-09-10",
        ...
        items: [
          {
            ...
            time: "16:00",
            title: "Dobrodošlica",
            description: "Nalepnice i kratko upoznavanje.",
          },
          {
            id: "2",
            time: "16:20",
            title: "Priča i crtanje",
            description: "Čitamo zajedno i bojimo stranice.",
          },
          {
            id: "3",
            time: "17:00",
            title: "Torta",
            description: "Jedna svećica i želja.",
          },
          {
            id: "4",
            time: "17:30",
            title: "Igre u bašti",
            description: "Blage trke i loptice.",
          },
        ],
      },
    },
