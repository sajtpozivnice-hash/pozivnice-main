...
const FormConfirmMessage: FC<Props> = ({ attendance, onClick }) => {
  ...
  return (
    <div className="border border-km-ink/10 px-6 py-12 text-left text-km-ink sm:px-10">
      <p className="km-eyebrow mb-4">{isYes ? "Hvala Vam" : "Žao nam je"}</p>
      <h3
      ...
      <p className="mt-4 text-sm text-km-muted">
        {isYes
