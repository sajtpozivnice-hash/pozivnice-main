...
export const krstenjeModernDefaultConfig: UniversalProjectConfig = {
  template: "krstenje-modern",
  eventType: "baptism",
  meta: {
  ...
  sections: [
    {
      ...
      data: {
        title: "Čist početak",
        subtitle: "Pozivnica za krštenje",
        backgroundImage:
        ...
        cards: [
          {
            ...
            text: "Početak ispunjen ljubavlju.",
          },
          {
            id: 2,
            title: "Proslava",
